                    ...
                    html += `<div class="col-4 mb-4">
                                <div class="card h-100">
                                    ...
                                    <div class="card-footer bg-white border-0 ">
                                        ...
                                        <button type="button" id="action2" data-value="test-drive" data-model="`+ car.model +`" class="btn btn-success w-auto float-right btn-lg test-drive">Teste Drive</button>
                                    </div>
                                </div>
                            </div>`
                    index++;
